...
\begin{align*}
    &\Exp{\| x_i \odot \bm{b} \|} = 1  \iff \ee{x_i \odot \bm{b} } = 1
\end{align*}
...
giving us that $\eta_j$ is sampled from $\mathcal{N}(0,)$ 
In this transformed space clipping can then be performed, such that the probability of clipping a point is less than 
Then the summ
