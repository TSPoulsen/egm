...
% And define b_j >= 0
% Use theorem 7.12 from "Matrix Differential Calculus with Applications in Statistics and Econometrics"
% Perhaps don't include proof and just argue that it is equivalent to the one solved in og paper
