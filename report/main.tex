...
Though the algoritghm seems short and simple as the the only thing thats really done is to draw samples from $\mathcal{N}(0, \lr{\sigma_{opt} \cdot \frac{\Delta_j}{b_j}}^2)$, 
